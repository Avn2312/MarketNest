...
const paymentMethods = [
    ...
    },
    {
        ...
        text: "Continue to secure Razorpay checkout for online payment.",
    },
];
...
const Cart = () => {
    ...
    const getUserAddresses = useCallback(async () => {
        try {
            ...
            const { data } = await axios.get("/api/addresses/get");
    ...
    const placeOrder = async () => {
        try {
            ...
            const { data } = await axios.post("/api/orders/razorpay", payload);
            ...
            if (data.success) {
                ...
                const razorpay = new window.Razorpay({
                    ...
                    name: "MarketNest",
                    description: "MarketNest order payment",
